                ...
                <div className='mt-20'>
                    <div className='bg-[#fff] hover:shadow-2xl border-1 rounded-lg p-2'>
                        <div className=' row md:mx-10'>
                            ...
                            <div className='basis-4/4 lg:basis-1/4 '>
                                <img className=''  src="https://instructory-aws-storage.s3.us-west-1.amazonaws.com/course_thumbnails/625e5c49304e3.jpg" alt="" />
                            </div>
